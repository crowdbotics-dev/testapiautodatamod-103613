...
## Project Structure
    ...
    ├── testapiautodatamod_103613  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_103613`
...
2. Clone this repo and `cd testapiautodatamod_103613`
